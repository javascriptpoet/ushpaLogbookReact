...
const go=(prop)=>()=>{window.location.href=Accounts.ui._options[prop]};
Accounts.ui._options = {
  ...
  onPostSignUpHook: go('profilePath'),
  onEnrollAccountHook: go('profilePath'),
  onResetPasswordHook: go('loginPath'),
  onVerifyEmailHook: go('profilePath'),
  onSignedInHook: go('homeRoutePath'),
  onSignedOutHook: go('homeRoutePath'),
};
